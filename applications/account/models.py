...
class CustomUser(AbstractUser):
    EXPERIENCE = (('нет опыта', 'нет опыта'), ('менее 6 месяцев', 'менее 6 месяцев'),
                  ('более 6 месяцев', 'более 6 месяцев'))
    ...
    experience = models.CharField(max_length=50, choices=EXPERIENCE, default='нет опыта')
